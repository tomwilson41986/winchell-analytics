...
export default function Horses() {
  ...
  const columns: Column<PortfolioCard>[] = [
    ...
    { key: 'damsire', header: 'Damsire', render: (r) => titleCase(r.damsire) },
        ...
        <>
          ...
          <section className="section">
            <div className="section__head">
              <h2 className="section__title">String analytics</h2>
            ...
            <div className="section__head">
              ...
              <div className="section__actions">
                ...
                <button
                  ...
                  onClick={() => downloadText('winchell-horses.csv', cardsToCsv(rows))}
